...
if __name__ == "__main__":
    ...
    data = {
        ...
        'experience': [''.join(['<b>SpkrBar</b> - Columbus, OH<br/>',
                    '<alignment=TA_RIGHT>Software Developer: September 2013 - Present</alignment><br/>',
                    'Develop and maintain the front and backend of a website using Python and the Django framework. ',
